...
<?
	...
	$filename= "../custom/news_adsense.html";
...
<form name="notizie" method="post" action="insert_adsensenews_query.php" enctype="multipart/form-data">
<!-- il valore di id lo passiamo alla pagina di action con un campo nascosto -->
	<h3><?=$parola?> Adsense per News:</h3>
