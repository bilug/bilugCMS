...
<form name="notizie" method="post" action="insert_css_query.php" enctype="multipart/form-data">
<!-- il valore di id lo passiamo alla pagina di action con un campo nascosto -->
	...
	<div class="float615">
	<a href="../utility/cssstile.css" target="_blank">Css Ufficiale</a></div>
	<div class="azzerafloat"></div>
	<br/>
