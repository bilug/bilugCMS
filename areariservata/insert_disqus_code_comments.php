...
<?
	...
	$filename= "../custom/disqus_code_comments.php";
	$handle = @fopen($filename,"r");
	$disqus = @fread($handle,filesize($filename));
	@fclose($handle);

?>
<div class="contenitore">
<form name="notizie" method="post" action="insert_disqus_code_comments_query.php" enctype="multipart/form-data">
<!-- il valore di id lo passiamo alla pagina di action con un campo nascosto -->
	<h3><?=$parola?> Codice Disqus:</h3>
	<div class="azzerafloat"></div>
	<div class="float140">HTML:</div>
	<div class="float615">
		<textarea name="testo" rows="20" cols="90"><?=$disqus?></textarea>
	</div>
	<div class="azzerafloat"></div>
	<br/>
