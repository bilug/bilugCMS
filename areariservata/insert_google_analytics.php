...
<?
	...
	$analitycs = @fread($handle,filesize($filename));
	@fclose($handle);

?>
<div class="contenitore">
<form name="notizie" method="post" action="insert_google_analytics_query.php" enctype="multipart/form-data">
<!-- il valore di id lo passiamo alla pagina di action con un campo nascosto -->
	<h3><?=$parola?> Codice analytics:</h3>
	<div class="azzerafloat"></div>
	<div class="float140">HTML:</div>
	<div class="float615">
		<textarea name="testo" rows="20" cols="90"><?=$analitycs?></textarea>
	</div>
	<div class="azzerafloat"></div>
	<br/>
