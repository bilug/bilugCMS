...
if (isset($_POST["op"]))
{
	$str="UPDATE parametri Set valore = './custom/main.php' where nomecampo='_CORPO' and  sezione = 0";
...
?>
<hr/>
<form name="modify_pagdef5" method="post" action="./area.php?pag=sel_pagdef5.php">
<div>
	- Pagina personalizzata main.php in custom<br/>
	<br/>	
</div>	
