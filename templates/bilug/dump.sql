...
--
-- Host: localhost
-- Generato il: Lug 03, 2012 alle 19:03
...
(2, 'Contatti', 't', 0, '#', 'sc', 2, 'Form per essere contattato', 1),
(3, 'Info', 't', 0, '#', 'hm', 3, 'Informazioni generali', 1),
(4, 'Sitemap', 't', 0, '#', 'hm', 4, 'Sitemap', 1);
...
(48, 'Men&ugrave; argomenti 1', 'Argomenti 1', NULL, NULL, NULL, NULL, NULL, 'index_arg1.php', 'd', 'si', 't', 2),
(49, 'Men&ugrave; argomenti 2', 'Argomenti 2', NULL, NULL, NULL, NULL, NULL, 'index_arg2.php', 'd', 'si', 't', 3),
...
(54, 'NewsBox1', 'NewsBox1', NULL, NULL, NULL, NULL, NULL, 'index_newsbox1.php', 's', 'si', 't', 1),
(55, 'NewsBox2', 'NewsBox2', NULL, NULL, NULL, NULL, NULL, 'index_newsbox2.php', 's', 'si', 't', 2),
(56, 'NewsBox3', 'NewsBox3', NULL, NULL, NULL, NULL, NULL, 'index_newsbox3.php', 's', 'no', 't', 0),
...
(64, 'Multilingue Bandierine', 'Scegli lingua', NULL, NULL, NULL, NULL, NULL, 'index_multilingue_bandierine.php', 's', 'no', 't', 0),
...
(72, 'Ultime news', 'Ultime news', NULL, NULL, NULL, NULL, NULL, 'index_ultime_news.php', 's', 'si', 't', 0),
...
(1, 'Numero di ultime notizie da visualizzare', '_MAX_LAST_ARG', 1, '2'),
