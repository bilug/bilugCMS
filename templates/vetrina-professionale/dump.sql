...
--
-- Host: localhost
-- Generato il: 29 giu, 2012 at 09:25 
...
--
-- Database: `BilugCMS Vetrina professionale`
--
...
(1, 'Home', 't', 0, '#', '', 1, 'La pagina di riferimento del tuo sito', 1),
(2, 'Contatti', 't', 0, '#', '', 2, 'Form per essere contattato', 1),
(3, 'Info', 't', 0, '#', '', 3, 'Informazioni generali', 1),
(4, 'Sitemap', 't', 0, '#', '', 4, 'Sitemap', 1);
...
(6, 'Pagine statiche', 'men&ugrave;', NULL, NULL, NULL, NULL, NULL, 'index_statichedb.php', 'd', 'no', 't', 0),
...
(54, 'NewsBox1', 'NewsBox1', NULL, NULL, NULL, NULL, NULL, 'index_newsbox1.php', 'c', 'si', 't', 1),
(55, 'NewsBox2', 'NewsBox2', NULL, NULL, NULL, NULL, NULL, 'index_newsbox2.php', 'c', 'si', 't', 2),
(56, 'NewsBox3', 'NewsBox3', NULL, NULL, NULL, NULL, NULL, 'index_newsbox3.php', 'c', 'si', 't', 3),
...
(70, 'Bottoni a pi&egrave; di pagina', 'Bottoni a pi&egrave; di pagina', NULL, NULL, NULL, NULL, NULL, 'index_bottoni_pie.php', 'b', 'si', 't', 2),
(71, 'Sitemap', 'Sitemap', NULL, NULL, NULL, NULL, NULL, 'index_sitemap.php', 'b', 'si', 't', 0),
